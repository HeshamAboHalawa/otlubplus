      ...
      try {
        ...
        stores.forEach((store, index) => {
          const storeMarker = L.marker([store.latitude, store.longitude], {
            icon: createCustomIcon("#D40301", `${index + 1}`, "store"),
          }).addTo(map);
          ...
          storeMarker.bindPopup(`
            <div style="min-width: 220px; padding: 8px;">
              <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
                <div style="width: 24px; height: 24px; background-color: #D40301; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px;">
                  ${index + 1}
                </div>
