      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid w-full sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {benefits.map((benefit, idx) => (
            <div
              key={idx}
              className="group bg-linear-to-br from-white to-gray-50 rounded-2xl p-5 border border-gray-200 hover:border-primary-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
          ...
          <div className="grid md:grid-cols-3 gap-6 relative z-20">
            {steps.map((item, idx) => (
              <div key={idx} className="relative">
                <div className="rounded-2xl p-5 border border-gray-200 hover:border-primary-400 transition-all hover:shadow-xl bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div
                key={idx}
                className="bg-linear-to-br from-gray-50 to-white rounded-lg p-5 border-2 border-gray-200 hover:border-primary transition-all hover:shadow-lg"
              >
